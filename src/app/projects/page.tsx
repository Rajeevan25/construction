...
export default function ProjectsPage() {
  ...
  return (
    <main className="relative min-h-screen bg-background text-foreground">
      ...
      {/* Projects Hero */}
      <section className="relative min-h-[50vh] flex items-center px-6 md:px-24 pt-32 pb-20 bg-muted/10 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-9xl font-black text-white uppercase font-heading tracking-tighter leading-none mb-8"
          >
            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-end">
                  <div>
                    <h3 className="text-3xl md:text-5xl font-black text-white uppercase font-heading tracking-tighter mb-2 leading-none group-hover:text-primary transition-colors">
                      {project.title}
                    </h3>
      ...
      <section className="py-32 container mx-auto max-w-7xl px-6">
        <div className="northstone-gradient rounded-3xl p-12 md:p-24 flex flex-col md:flex-row items-center justify-between gap-12 shadow-2xl shadow-primary/20">
